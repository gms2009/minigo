...
def main(unused_argv):
    ...
    for i in range(0, NUM_LOOP):
        if i == 0:
            ...
            bootstrap_model_path = os.path.join(fsdb.models_dir(), src_model_name)
        ...
        selfplay_cmd = [
            'python3', 'selfplay.py',
            '--load_file={}'.format(src_model_path),
            '--selfplay_dir={}'.format(os.path.join(fsdb.selfplay_dir(), dst_model_name)),
            '--holdout_dir={}'.format(os.path.join(fsdb.holdout_dir(), dst_model_name)),
